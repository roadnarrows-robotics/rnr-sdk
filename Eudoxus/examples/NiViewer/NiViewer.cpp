...
static bool  OptsChooseDevice = false;  ///< do [not] choose device from menu
static char *ArgOniFileName   = NULL;   ///< ONI file name
...
static OptsInfo_T AppOptsInfo[] =
{
  ...
  // -d, --devices
  {
    ...
    no_argument,          // has_arg
    true,                 // has_default
    &OptsChooseDevice,    // opt_addr
    OptsCvtArgBool,       // fn_cvt
    OptsFmtBool,          // fn_fmt
    NULL,                 // arg_name
    "Choose device.",     // opt desc
  },
...
int main(int argc, char **argv)
{
  ...
  if( (rc = MainInit(argc, argv)) != XN_STATUS_OK )
  {
    return rc;
  }
  ...
  // .........................................................................
	...
	if( ArgOniFileName != NULL )
	{	
		xnLogInitFromXmlFile(strCfgFile.c_str());
		rc = openDeviceFile(ArgOniFileName);
	}
	else if (OptsChooseDevice)
	{
		rc = openDeviceFromXmlWithChoice(strCfgFile.c_str(), errors);
	}
	else
	{
		rc = openDeviceFromXml(strCfgFile.c_str(), errors);
	}
