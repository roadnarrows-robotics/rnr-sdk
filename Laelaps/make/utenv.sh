#
# Handy little script to fix up environment to run the Laelaps package
# applications and scripts prior to installing.
#
# Usage: ./utenv.sh
#
...
# load library path
_distlib_path=${_pkgroot}/dist/dist.${_utarch}/lib:${_pkgroot}/dist/dist.${_utarch}/lib/botsense:${_pkgroot}/dist/dist.${_utarch}/lib/rnr
