...
int dxl_initialize(int deviceIndex, int baudnum )
{
  ...
  /*! \todo RDK TODO fix for new extend baudnums */
...
void dxl_rx_packet(void)
{
	...
	if( gbRxGetLength < gbRxPacketLength )
	{
			...
			else
      {
        ...
        //fprintf(stderr, "rdk: partial frame received\n");
      }
			giBusUsing = 0;
			return;
		}
	...
	{
		gbCommStatus = COMM_RXCORRUPT;
    //fprintf(stderr, "rdk: ids mismatch\n");
		giBusUsing = 0;
		return;
	}
...
unsigned char dxl_get_rxpacket_errbits()
{
